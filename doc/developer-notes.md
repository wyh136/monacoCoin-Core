...
monacoCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as monacoCoin Core, where everyone uses
...
pay attention to for reviewers of monacoCoin Core code.

General monacoCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: monacoCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
