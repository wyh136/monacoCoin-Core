...
Only requiring some minor changes is monacoCoin.cpp.
...
Changes to monacoCoin.cpp
----------------------
monacoCoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
