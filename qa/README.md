...
Every pull request to the monacoCoin Core repository is built and run through
...
```
  ...
  --srcdir=SRCDIR       Source directory containing monacoCoind/monacoCoin-cli
                        (default: ../../src)
...
blocks (25*500=12500 MCC) in its wallet.
