...
if "DASHD" not in os.environ:
    os.environ["DASHD"] = buildDir + '/src/monacoCoind' + EXEEXT
if "DASHCLI" not in os.environ:
    os.environ["DASHCLI"] = buildDir + '/src/monacoCoin-cli' + EXEEXT
...
#    'rpcbind_test.py', #temporary, bug in libevent, see #6655
    ...
    'mempool_packages.py',
    'maxuploadtarget.py',
    # 'replace-by-fee.py', # RBF is disabled in monacoCoin Core
]
