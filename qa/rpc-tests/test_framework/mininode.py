# mininode.py - monacoCoin P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a monacoCoin node
# NodeConnCB: a base class that describes the interface for receiving
#             callbacks with network messages from a NodeConn
# CBlock, CTransaction, CBlockHeader, CTxIn, CTxOut, etc....:
#     data structures that should map to corresponding structures in
#     monacoCoin/primitives
...
# Objects that map to monacoCoind objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in monacoCoind indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=1):
        ...
        print 'MiniNode: Connecting to monacoCoin Node IP # ' + dstaddr + ':' \
            + str(dstport)
