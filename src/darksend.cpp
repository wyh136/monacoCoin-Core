...
{
    if(fLiteMode) return; // ignore all monacoCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat monacoCoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("monacoCoin-privatesend");
