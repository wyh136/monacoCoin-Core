...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("monacoCoin Core monacoCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  monacoCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded monacoCoin transaction") + "\n" +
              "  monacoCoin-tx [options] -create [commands]   " + _("Create hex-encoded monacoCoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded monacoCoin transaction
