...
// Copyright (c) 2014-2017 The monacoCoin Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("MonacoCoin Core - Genesis") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About monacoCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about monacoCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for monacoCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your monacoCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified monacoCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a monacoCoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the monacoCoin Core help message to get a list with possible monacoCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("monacoCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MonacoCoin network", "", count));
}
...
{
    QString strTitle = tr("MonacoCoin Core"); // default title
    ...
    // Append title to "MonacoCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
