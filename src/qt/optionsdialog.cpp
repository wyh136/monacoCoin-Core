    ...
    mapper(0)
{
    ...
    /* Theme selector 
    /*ui->theme->addItem(QString("monacoCoin-light"), QVariant("light"));
    ui->theme->addItem(QString("monacoCoin-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("monacoCoin-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("monacoCoin-traditional"), QVariant("trad"));*/
