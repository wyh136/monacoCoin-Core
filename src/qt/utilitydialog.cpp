    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("MonacoCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About MonacoCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  monacoCoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the MonacoCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MCC, 0.1 MCC, 1 MCC and 10 MCC -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("MonacoCoin Core is shutting down...") + "<br /><br />" +
