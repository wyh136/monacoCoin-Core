...
2. run monacoCoind with -printalert or -sendalert like this:
   /path/to/monacoCoind -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.monacoCoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/monacoCoin Core:0.12.0.58/"));
